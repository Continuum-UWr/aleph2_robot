#ifndef ALEPH2_HARDWARE_INTERFACE_INCLUDE_ALEPH2_HARDWARE_INTERFACE_UTILS_H_
#define ALEPH2_HARDWARE_INTERFACE_INCLUDE_ALEPH2_HARDWARE_INTERFACE_UTILS_H_
...
void LoadNanotecParametersFromStruct(std::map<std::string, int64_t>* parameters,
                                     XmlRpc::XmlRpcValue str) {
  for (auto& param : str) {
...
std::string LoadOptionalRubiFieldFromStruct(const std::string field_name,
                                            XmlRpc::XmlRpcValue str) {
...
#endif  // ALEPH2_HARDWARE_INTERFACE_INCLUDE_ALEPH2_HARDWARE_INTERFACE_UTILS_H_
