...
{
    Aleph2HardwareInterface::Aleph2HardwareInterface(ros::NodeHandle& nh) : nh_(nh) {
        init();
    ...
    void Aleph2HardwareInterface::init() {
        // Get joint names
        nh_.getParam("aleph2/hardware_interface/joints", joint_names_);
